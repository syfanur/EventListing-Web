...
<head>
    ...
    <title>EVENT.KUY | Confirm Paid</title>
       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="col-md-6"><!-- col-md-6 Begin -->
               ...
               <ul class="menu"><!-- cmenu Begin -->
                   ...
                   <li>
                       <a href="http://localhost:8080/tubes/admin_area/index.php?dashboard">Admin Page</a>
                   </li>
               ...
               <div class="box-details"><!-- box Begin -->
                   ...
                   <form action="confirm.php?update_id=<?php echo $order_id; ?>" method="post" enctype="multipart/form-data"><!-- form Begin -->
                       ...
                       <div class="form-group"><!-- form-group Begin -->
                           ...
                           <label>Payment Image (Image Name : *invoice-no*_*your-name* )</label>

                           <input type="file" class="form-control form-height-custom" name="payment_img" required>
                   ...
                   <?php
                    ...
                    if(isset($_POST['confirm_payment'])) {
                        ...
                        $payment_img_tmp = $_FILES['payment_img']['tmp_name'];
                        $payment_process = 'Waiting';
                        $complete = "Complete";

                        move_uploaded_file($payment_img_tmp,"payment_images/$payment_img");

                        $insert_payment = "INSERT INTO payments (invoice_no,payment_img,payment_process) VALUES ('$invoice_no','$payment_img','$payment_process')";
